About human-dynamics-estimation-feedstock
=========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/human-dynamics-estimation-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/human-dynamics-estimation-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add human-dynamics-estimation libhuman-dynamics-estimation
# for installing globally
pixi global install human-dynamics-estimation libhuman-dynamics-estimation
```
...
It is possible to list all of the versions of `human-dynamics-estimation` available on your platform:
...
```
pixi search human-dynamics-estimation --channel conda-forge
```
